<?php return [
    ...
    'errors' => [
        ...
        'login_not_permitted'   => 'User is not premitted to log in',
    ...
    'permissions' => [
        ...
        'user_own_password_change' => 'Change your account password',
        'no_password_change_comment' => 'You do not have permission to change your password',
    ],
    'models' => [
        'user' => [
